...
honeybee_arima['Honeybee First Difference'] = honeybee_arima - honeybee_arima.shift(2)
honeybee_arima['Seasonal First Difference']=honeybee_arima["numcol"]-honeybee_arima["numcol"].shift(12)

train['Honeybee First Difference'] = train - train.shift(2)
train['Seasonal First Difference']=train["numcol"]-train["numcol"].shift(12)

test['Honeybee First Difference'] = test - test.shift(2)
